...
public abstract class ExamplePieceMarcus extends Piece
{
    ...
    public ExamplePieceMarcus(GameManager inputManager, Point inputCenter, BoardPoint inputLocation)
    {
    ...
    public void initializeSymbol()
    {
        ...
        symbol.moveTo(center.x - 15, center.y + 15);
        symbol.lineTo(center.x - 7.5, center.y - 15);
        symbol.lineTo(center.x, center.y + 10);
        symbol.lineTo(center.x + 7.5, center.y - 15);
        symbol.lineTo(center.x + 15, center.y + 15);
        symbol.lineTo(center.x + 12, center.y + 15);
        symbol.lineTo(center.x + 7.5, center.y - 12);
        symbol.lineTo(center.x, center.y + 13);
        symbol.lineTo(center.x - 7.5, center.y - 12);
        symbol.lineTo(center.x - 12, center.y + 15);
        symbol.lineTo(center.x - 15, center.y + 15);
    }
