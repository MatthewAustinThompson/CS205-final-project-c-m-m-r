...
public abstract class ExamplePieceMatthew extends Piece
{
    ...
    public ExamplePieceMatthew(GameManager inputManager, Point inputCenter, BoardPoint inputLocation)
    {
    ...
    public void initializeSymbol()
    {
        ...
        symbol.moveTo(center.x - 24, center.y + 20);
        symbol.lineTo(center.x - 24, center.y + 24);
        symbol.lineTo(center.x + 24, center.y + 22);

        // Vertical stroke
        symbol.moveTo(center.x - 2, center.y - 26);
        symbol.lineTo(center.x + 2, center.y - 26);
        symbol.lineTo(center.x, center.y + 26);
        
        // Top horizontal stroke
        symbol.moveTo(center.x - 28, center.y - 8);
        symbol.lineTo(center.x - 28, center.y - 4);
        symbol.lineTo(center.x + 28, center.y - 6);
    }
